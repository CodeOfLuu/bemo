...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi Bé Mỡ!";
    let charArrTitle = textTitle.split('');
let text = "Nhân ngày lễ lộc, rảnh rỗi nên dành tý thời gian viết vài lời gửi đến bạn, đón nhận nhé! Chúc bạn có 1 mùa giáng sinh an lành và ấm áp nè, đặt biết bớt OVTK nháaa! Nói sơ sơ vậy thui, tui sợ đem văn vở vào bạn lại rơi nước mắt :))"
